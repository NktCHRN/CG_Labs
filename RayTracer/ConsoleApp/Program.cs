...
//Vector3F
/* intersects */
/*Vector3F rayOrigin = new Vector3F(0.0f, 0.0f, -5.0f);
...
/* does not intersect */
Vector3F rayOrigin = new Vector3F(-4f, 2.0f, 0.0f);
Vector3F rayDir = new Vector3F(0.0f, 1.0f, 0.0f);
Vector3F v0 = new Vector3F(1.0f, 0.0f, 1.0f);
Vector3F v1 = new Vector3F(-1.0f, 0.0f, 1.0f);
